...
import Controller.ControllerDialogDataset;

/**
 *
 * @author RIDWAN
 */
public class FormDialogDataset extends javax.swing.JDialog {

    /**
     * Creates new form ViewDialogDatasets
     */
    public FormDialogDataset(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocation(450, 90);
        setTitle("Dataset");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormDialogDataset.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormDialogDataset dialog = new FormDialogDataset(new javax.swing.JFrame(), true);
